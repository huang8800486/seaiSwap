...
export const NFT_ADDRESS: Record<number, string> = {
  [-1]: '0xb47c19a46C04d8A5E06992a855b6BC7984be9D0E',
  [ChainId.BSC]: '0xb47c19a46C04d8A5E06992a855b6BC7984be9D0E',
  [ChainId.BSC_TESTNET]: '0xb47c19a46C04d8A5E06992a855b6BC7984be9D0E',
}
// NFT地址分红合约
export const NFT_DIVIDENDS_ADDRESS: Record<number, string> = {
  [-1]: '0x173099Af0e2A57F0910C7c97FBcF6071FF6522D2',
  [ChainId.BSC]: '0x173099Af0e2A57F0910C7c97FBcF6071FF6522D2',
  [ChainId.BSC_TESTNET]: '0x173099Af0e2A57F0910C7c97FBcF6071FF6522D2',
}
